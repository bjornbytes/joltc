...
/* ScaledShape */
JPH_CAPI JPH_ScaledShapeSettings* JPH_ScaledShapeSettings_Create(const JPH_Vec3* scale, const JPH_ShapeSettings* shapeSettings);
JPH_CAPI JPH_ScaledShapeSettings* JPH_ScaledShapeSettings_Create2(const JPH_Vec3* scale, const JPH_Shape* shape);
